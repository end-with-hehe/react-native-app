                ...
                <ScrollView style={styles.main.rightRow}>
                    <View style={styles.main.rightRow.item}>
                        <View style={styles.main.rightRow.item.title}>
                            <Text style={styles.main.rightRow.item.title.item}>第2350832期</Text>
                            <Text style={[styles.main.rightRow.item.title.item,styles.main.rightRow.item.title.win]}>未中奖</Text>
                        </View>
                        <View style={styles.main.rightRow.item.money}>
                            <Text style={[styles.main.rightRow.item.money.item,styles.main.rightRow.item.money.win]}>+120</Text>
                        </View>
                        <Text style={styles.main.rightRow.item.code}>投注金额：10.07</Text>
                        <Text style={styles.main.rightRow.item.time}>购&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;买：高赔-混合【大单：10元】 高赔-混合【大单：10元】 高赔-混合【大单：10元】</Text>
                        <Text style={styles.main.rightRow.item.time}>操作时间：2018-11-08 17:25:56</Text>
                    </View>
                    <View style={styles.main.rightRow.item}>
                        <View style={styles.main.rightRow.item.title}>
                            <Text style={styles.main.rightRow.item.title.item}>第2350832期</Text>
                            <Text style={[styles.main.rightRow.item.title.item,styles.main.rightRow.item.title.lose]}>未中奖</Text>
                        </View>
                        <View style={styles.main.rightRow.item.money}>
                            <Text style={[styles.main.rightRow.item.money.item,styles.main.rightRow.item.money.lose]}>-120</Text>
                        </View>
                        <Text style={styles.main.rightRow.item.code}>投注金额：10.07</Text>
                        <Text style={styles.main.rightRow.item.time}>购&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;买：AC1541856464565</Text>
                        <Text style={styles.main.rightRow.item.time}>操作时间：2018-11-08 17:25:56</Text>
                    </View>
                </ScrollView>
            </View>
