...
export default class Main extends Component{
    ...
    render(){
        return (
            ...
            >
                <View tabLabel="个人盈亏" style={styles.main.list}>
                    <Image source={require('./nodata.png')} style={styles.main.nodata}/>
                </View>

                <View tabLabel="充值记录" style={styles.main.list}>
                    <View style={styles.main.list.item}>
                        <View style={styles.main.list.item.title}>
                            <Text style={styles.main.list.item.title.item}>存入金额</Text>
                        ...
                        <Text style={styles.main.list.item.code}>充值流水：<Text style={{color:'#000'}}>UQ5336970775754564</Text></Text>
                        <Text style={styles.main.list.item.time}>充值方式：<Text style={{color:'#000'}}>银行卡转账</Text></Text>
                ...
                <View tabLabel="提款记录" style={styles.main.list}>
                    <View style={styles.main.list.item}>
                        <View style={styles.main.list.item.title}>
                            <Text style={styles.main.list.item.title.item}>反水金额</Text>
                            <Text style={[styles.main.list.item.title.item,styles.main.list.item.title.win]}>已审核</Text>
                ...
                <View tabLabel="优惠记录" style={styles.main.list}>
                    <View style={styles.main.list.item}>
                        <View style={styles.main.list.item.title}>
                            <Text style={styles.main.list.item.title.item}>反水金额</Text>
                            <Text style={[styles.main.list.item.title.item,styles.main.list.item.title.win]}>已审核</Text>
...
const pageStyles = {
    main:{
        ...
        nodata:{
            width:200,
            height:188,
            marginLeft:(SCREEN_WIDTH-230)*0.5,
            marginTop:150,
        },
        list:{
            padding:15,
